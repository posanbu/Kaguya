 ...
 * 代码库关系：测试 `information-modules.ts` 及其经由 `index.ts` 的 SDK 出口；
 * `InformationModuleHost` 依赖同一 subscription definition 把消费者注册到 Core。
...
import * as informationModules from "./information-modules.js";
...
describe("information module SDK", () => {
  it("defines non-targeted subscriptions that register derived atoms", () => {
    ...
    expect(subscription).toMatchObject({ kind: inputKind.kind, definition: inputKind });

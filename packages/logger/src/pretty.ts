...
const MODULE_NAMES: Readonly<Record<string, string>> = {
  ...
  "core.association.memory": "联想",
  "agent.memory.writeback": "记忆写入",
...
const EVENT_NAMES: Readonly<Record<string, string>> = {
  ...
  "association.completed": "联想检索完成",
  "association.query": "查询联想记忆",
  "association.candidate": "找到记忆候选",
  ...
  "expression.learned": "表达习惯学习完成",
  "expression.selected": "表达习惯选择完成",

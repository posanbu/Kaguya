 ...
 * 主要职责：createFirstPartyModuleCatalog 接收宿主 Model Task token 和共享 completed kind，构造身份、时机、light tier 发言 Planner 与消息合成定义；
...
import { createSpeechModule } from "./speech/index.js";
